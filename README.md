**Site Insights Pro** is a lightweight and powerful WordPress analytics plugin designed to help website owners monitor visitor activity directly from the WordPress dashboard. It provides clear, actionable insights into your site's performance without relying on external analytics platforms.
...
Flexible access control based on user capabilities
Customizable dashboard themes, including dark mode
Fully open-source and free to use
Easy to extend, customize, and integrate into any WordPress project
Shortcode Usage
...
**License**
This plugin is free and open-source. You are welcome to use, modify, and distribute it according to the terms of its license.
